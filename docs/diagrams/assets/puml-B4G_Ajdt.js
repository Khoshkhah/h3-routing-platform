...
rectangle "Shortcut Generator" <<H3RoutingPlatformShortcutGenerator>> as H3RoutingPlatformShortcutGenerator {
  skinparam RectangleBorderColor<<H3RoutingPlatformShortcutGenerator>> #3b82f6
  skinparam RectangleFontColor<<H3RoutingPlatformShortcutGenerator>> #3b82f6
...
rectangle "duckOSM" <<H3RoutingPlatformDuckOSM>> as H3RoutingPlatformDuckOSM {
  skinparam RectangleBorderColor<<H3RoutingPlatformDuckOSM>> #3b82f6
  skinparam RectangleFontColor<<H3RoutingPlatformDuckOSM>> #3b82f6
...
@enduml
`;case"routingSequence":return`@startuml
