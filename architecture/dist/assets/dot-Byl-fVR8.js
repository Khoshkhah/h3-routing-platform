function e(t){switch(t){case"index":return`digraph {
    graph [TBbalance=min,
        bgcolor=transparent,
        compound=true,
        fontname=Arial,
...
`;default:throw new Error("Unknown viewId: "+t)}}function n(t){switch(t){case"index":return`<?xml version="1.0" encoding="UTF-8" standalone="no"?>
