...
rectangle "Shortcut Generator" <<H3RoutingPlatformShortcutGenerator>> as H3RoutingPlatformShortcutGenerator {
  ...
  rectangle "==phase1\\n\\nPhase 1: Forward Chunked (res 15→7)" <<H3RoutingPlatformShortcutGeneratorPhase1>> as H3RoutingPlatformShortcutGeneratorPhase1
  rectangle "==phase2\\n\\nPhase 2: Forward Consolidation (res 6→0)" <<H3RoutingPlatformShortcutGeneratorPhase2>> as H3RoutingPlatformShortcutGeneratorPhase2
  rectangle "==phase3\\n\\nPhase 3: Backward Consolidation (res 0→7)" <<H3RoutingPlatformShortcutGeneratorPhase3>> as H3RoutingPlatformShortcutGeneratorPhase3
  rectangle "==phase4\\n\\nPhase 4: Backward Chunked (res 8→15)" <<H3RoutingPlatformShortcutGeneratorPhase4>> as H3RoutingPlatformShortcutGeneratorPhase4
}

H3RoutingPlatformOsmData .[#8D8D8D,thickness=2].> H3RoutingPlatformDuckOSM : "<color:#8D8D8D>Input<color:#8D8D8D>"
H3RoutingPlatformDuckOSM .[#8D8D8D,thickness=2].> H3RoutingPlatformDuckdb : "<color:#8D8D8D>Creates road graph<color:#8D8D8D>"
H3RoutingPlatformShortcutGeneratorPhase1 .[#8D8D8D,thickness=2].> H3RoutingPlatformShortcutGeneratorPhase2 : "<color:#8D8D8D>Flows to<color:#8D8D8D>"
H3RoutingPlatformShortcutGeneratorPhase2 .[#8D8D8D,thickness=2].> H3RoutingPlatformShortcutGeneratorPhase3 : "<color:#8D8D8D>Flows to<color:#8D8D8D>"
H3RoutingPlatformShortcutGeneratorPhase3 .[#8D8D8D,thickness=2].> H3RoutingPlatformShortcutGeneratorPhase4 : "<color:#8D8D8D>Flows to<color:#8D8D8D>"
H3RoutingPlatformDuckdb .[#8D8D8D,thickness=2].> H3RoutingPlatformShortcutGenerator : "<color:#8D8D8D>Input edges<color:#8D8D8D>"
H3RoutingPlatformShortcutGenerator .[#8D8D8D,thickness=2].> H3RoutingPlatformDuckdb : "<color:#8D8D8D>Writes shortcuts<color:#8D8D8D>"
H3RoutingPlatformH3Toolkit .[#8D8D8D,thickness=2].> H3RoutingPlatformShortcutGenerator : "<color:#8D8D8D>H3 utilities<color:#8D8D8D>"
@enduml
